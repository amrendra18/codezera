...
public class UpcomingFragment extends BaseFragment implements ContestAdapter.ShareListener {
    ...
    */
    ...
    private LoaderManager.LoaderCallbacks<Cursor> currentContestLoaderCallbacks
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            Debug.c();
            Uri uri = DBContract.ContestEntry.buildFutureContestUri(DateUtils.getCurrentEpochTime());
